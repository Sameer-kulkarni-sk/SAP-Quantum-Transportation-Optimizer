...
class QAOAOptimizer(BaseOptimizer):
    ...
    def optimize(self,
        ...
        try:
            ...
            # Check if QAOA found a valid solution
            if len(assignments) == 0:
                log("Applying Greedy optimization for final solution...")
                ...
                greedy_result.algorithm = f"QAOA + Greedy Hybrid"
                greedy_result.metadata = {
                    'hybrid_approach': True,
                    'qaoa_preprocessing': True,
