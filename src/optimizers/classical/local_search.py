...
class LocalSearchOptimizer(BaseOptimizer):
    ...
    def optimize(self,
        ...
        """
        Run local search optimization with simulated annealing

        Raspberry Pi Optimized Parameters:
        - max_iterations: 2000 (default, increased from 1000)
        - For faster results on Pi: use 1000-1500
        - For better quality on Pi: use 3000-5000
        - Desktop/Server: can use 5000-10000

        Args:
            max_iterations: Maximum number of iterations (Pi default: 2000)
            ...
            adaptive_cooling: Use adaptive cooling rate based on progress
        ...
        while iteration < max_iterations and temperature > min_temperature:
            ...
            # Adaptive cooling: speed up if stagnating
            if adaptive_cooling and stagnation_counter > 50:
                temperature *= cooling_rate * 0.95  # Faster cooling
                stagnation_counter = 0
            else:
